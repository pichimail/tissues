...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    // Kick off the animation loop once on first interaction in some paths
    // (the original code starts it from the first move handler)
  ...
  return (
    <div
      style={{
        ...
        top: 0,
        left: 0,
        // IMPORTANT: lowered z-index so this acts purely as a decorative background layer.
        // All homepage UI (cards, inputs, buttons, preview, sidebar) will render above it.
        zIndex: -1,
        pointerEvents: 'none',
        width: '100%',
        height: '100%'
